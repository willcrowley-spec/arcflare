...
import { ArrowRight, ChevronDown, Loader2, MessageSquareText } from 'lucide-react'
...
export function GapsPanel() {
  ...
  const visibleGaps = useMemo(() => {
    if (showAll || openGaps.length <= 5) return openGaps
    return openGaps.slice(0, 3)
  }, [openGaps, showAll])
                ...
                >
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    <button
                      type="button"
                      onClick={() => {
                        openContextualChat({ type: 'gap', id: g.id })
                      }}
                    ...
                    <button
                      ...
                      onClick={() =>
                        updateGap.mutate({
                          ...
                          data: {
                            gap_status: 'resolved',
                            resolution_note: 'Dismissed from Processes page',
                          },
                        })
                      }
